...
app_path = '/var/www/www.texas-trees.org/current'

# Set unicorn options
worker_processes 2
preload_app true
timeout 30
listen "#{app_path}/tmp/sockets/unicorn.texas-trees.sock", :backlog => 1024
...
before_fork do |server, worker|
  ...
  old_pid = "#{app_path}/tmp/pids/unicorn.texas-trees.pid.oldbin"
